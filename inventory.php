  ...
  <!-- pageContent -->
	<section class="full-width pageContent">
		...
		<div class="mdl-grid">
          ...
          <thead>
            <tr>
              <th scope="col" class="mdl-data-table__cell--non-numeric"> <center>Codigo Producto</center></th>
              <th scope="col"> <center>Descripcion</center></th>
              <th scope="col"> <center>Precio Mayorista</center></th>
              <th scope="col"> <center>Precio Minorista</center></th>
              <th scope="col"> <center>Existencia Actual</center></th>
            </tr>
          </thead>
          ...
          <tbody>
            <tr>
              <td scope="row" 0> <center> <strong> <?php echo $row["Secuencia_Registro_Producto"]; ?></strong> </center> </td>
              <td> <center> <?php echo $row["Descripcion_Producto"]; ?></center></td>
              <td><center><?php echo $row["Precio_Mayorista"]; ?></center></td>
              <td><center><?php echo $row["Precio_Minorista"]; ?></center></td>
              <td><center><?php echo $row["Existencia_Actual"]; ?></center></td>
            <?php } ?>
            </tr>
            <tr>
